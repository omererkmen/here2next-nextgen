  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "flex h-10 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#183690] focus:border-[#183690] disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      >
