            ...
            <div className="hidden sm:flex items-center gap-2">
              {user ? (
                <>
                    ...
                    <div className="relative" onMouseEnter={() => setAdminMenuOpen(true)} onMouseLeave={() => setAdminMenuOpen(false)}>
                      ...
                      {adminMenuOpen && (
                        <div className="absolute top-full right-0 w-52 bg-white border border-slate-200 rounded-lg shadow-lg py-1 z-50">
                          ...
                          <Link href="/admin/startups" className="flex items-center gap-2 px-4 py-2 text-sm text-[#183690] hover:bg-emerald-50" onClick={() => setAdminMenuOpen(false)}>
                  ...
                  <Link href="/profile">
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 rounded-md hover:bg-slate-100 transition-colors cursor-pointer">
                      <User className="w-4 h-4 text-[#183690]" />
                ...
                <>
                  ...
                  <Link href="/register">
                    <Button size="sm" className="bg-[#183690] hover:bg-[#102668] gap-2">
                ...
                {user ? (
                    ...
                    {userRole === 'admin' ? (
                      <>
                        ...
                        <Link href="/admin/startups" onClick={() => setMobileOpen(false)}>
                          <Button variant="ghost" size="sm" className="w-full gap-2 justify-start text-[#edac46]">
                  ...
                  <>
                    ...
                    <Link href="/register" onClick={() => setMobileOpen(false)}>
                      <Button size="sm" className="w-full bg-[#183690] hover:bg-[#102668] gap-2 justify-start">
                        <UserPlus className="w-4 h-4" />
                        {t("nav.signup")}
                      </Button>
                    </Link>
