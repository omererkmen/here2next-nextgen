        ...
        <Card className="max-w-md w-full">
          <CardContent className="p-8 text-center">
            <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
              <CheckCircle className="text-[#183690]" size={32} />
            </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 mb-4">
            {isStartup ? <Rocket className="text-[#183690]" size={32} /> : <Building2 className="text-[#183690]" size={32} />}
          </div>
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          {[1, 2].map((s) => (
            <div
              key={s}
              className={`h-2 rounded-full transition-all ${s <= step ? 'bg-[#183690] w-16' : 'bg-gray-200 w-8'}`}
            />
          ))}
        </div>
          ...
          <CardContent className="p-8">
            {step === 1 && (
              <div className="space-y-5">
                ...
                <Button onClick={handleStep1Next} className="w-full bg-[#183690] hover:bg-[#102668] mt-2">
