...
const translations: Record<string, { tr: string; en: string }> = {
  ...
  // CVC Circle
  "nav.cvc": { tr: "CVC Circle", en: "CVC Circle" },
  "cvc.title": { tr: "CVC & POC Circle", en: "CVC & POC Circle" },
  "cvc.subtitle": { tr: "POC & Co-Invest", en: "POC & Co-Invest" },
  "cvc.desc": { tr: "Farklı dikeylerde uzman kurumsal şirketlerce startup POC süreçlerini yürütmek ve ardından yatırım süreçlerini başlatmak.", en: "Running startup POC processes by expert corporates across different verticals and initiating investment processes." },
  "cvc.stats.meetings": { tr: "Circle Toplantısı", en: "Circle Meetings" },
  "cvc.stats.stakeholders": { tr: "Paydaş Sayısı", en: "Stakeholders" },
  "cvc.stats.deepdive": { tr: "Deep Dive", en: "Deep Dive" },
  "cvc.stats.decks": { tr: "Investment Deck", en: "Investment Decks" },
  "cvc.stats.coinvest": { tr: "Eş Yatırım", en: "Co-Investments" },
  "cvc.stats.schedule": { tr: "Her Çarşamba 16:00", en: "Every Wednesday 4PM" },
  "cvc.learnings.title": { tr: "Neler Öğrendik?", en: "What We Learned" },
  "cvc.learnings.1": { tr: "Farklı girişimleri birlikte tanıyarak perspektif kazandık.", en: "We gained perspective by getting to know startups together." },
  "cvc.learnings.2": { tr: "Kurumsal iş süreçlerimizde destek aldık.", en: "We received support in our corporate business processes." },
  "cvc.learnings.3": { tr: "Birlikte yatırım yaptık, ortak olduk.", en: "We co-invested and became partners." },
  "cvc.stakeholders.title": { tr: "En Aktif Paydaşlarımız", en: "Most Active Stakeholders" },
  "cvc.startups.title": { tr: "Görüşülen Girişimler", en: "Startups Reviewed" },
  "cvc.poc.title": { tr: "POC Yapılan Girişimler", en: "POC Startups" },
  "cvc.invested.title": { tr: "Yatırım Yapılan Girişimler", en: "Invested Startups" },
  "cvc.benefits.title": { tr: "Katkılar", en: "Benefits" },
  "cvc.benefits.startups": { tr: "Girişimlere Katkıları", en: "Benefits for Startups" },
  "cvc.benefits.startups.desc": { tr: "Başarılı POC süreçleri sonunda farklı kurumlardan yatırım alma fırsatı.", en: "Opportunity to receive investment from different corporates after successful POC processes." },
  "cvc.benefits.investors": { tr: "Yatırımcılara Katkıları", en: "Benefits for Investors" },
  "cvc.benefits.investors.desc": { tr: "Farklı dikeylerdeki kurumsal yapılardan girişimlerin teknik yeterliliği hakkında Know-How aktarımı.", en: "Know-how transfer about startups' technical competence from corporate structures across different verticals." },
  "cvc.whats.new": { tr: "Yenilikler", en: "What's New" },
  "cvc.new.guests": { tr: "Paydaş olmayan yatırımcıların toplantılara konuk alınması", en: "Inviting non-stakeholder investors as guests to meetings" },
  "cvc.new.vc": { tr: "Girişim sunumları yanında Girişim Sermayesi Fonları ve VC sunumları", en: "VC fund presentations alongside startup presentations" },
  "cvc.new.linkedin": { tr: "LinkedIn üzerinden CVC-POC Circle iletişim grubu", en: "CVC-POC Circle communication group on LinkedIn" },
  "cvc.cta": { tr: "Toplantılarımıza Bekleniyorsunuz", en: "You're Invited to Our Meetings" },
};
